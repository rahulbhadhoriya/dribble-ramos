...
export default function Main() {
  return (
    <div className="mx-16 text-black">
      ...
      <div className="bg-gray-100 border-hidden rounded-[40px] mx-[-4rem] p-12">
        <div
          className="flex"
          data-aos="fade-up"
        ...
        >
          <div className="text-6xl w-3/5 my-20 text-start font-medium ml-5">
            Your key to strategic
            <br /> sucess through analytics
          </div>

          <div className="text-2xl w-2/5 my-20 text-center font-light">
        ...
        >
          <div className="bg-white flex shadow-lg justify-space w-3/5 border-solid border-1 border-gray-200 rounded-[20px] p-6">
            <div className=" w-1/2 my-10">
              ...
              <div
                className="text-base text-gray-400 ml-[20px]"
                data-aos="fade-up"
                data-aos-duration="500"
                data-aos-easing="ease-in-out"
              >
            ...
            <div className="bg-slate-50 w-1/2 mt-10 border-solid border-1 border-gray-200 rounded-[10px] mr-[-4rem] ">
              image 1
            </div>
          </div>
          <div
        ...
        >
          ...
          <div>
            ...
            <br />
            algorith providein sight from data, reduce time for
            analysis
